...
folder_output = 'output_Kontinu_CN_Polutan_Terhadap_Waktu';
...
for s = 1:numel(scenario)
    ...
    rv = [10 12 14 16 19 21 23 24 26 28 30 32 34 36 38 40 42];
    ...
    nama_file = sprintf('cn_kontinu_waktu_skenario_%d.png', s);
