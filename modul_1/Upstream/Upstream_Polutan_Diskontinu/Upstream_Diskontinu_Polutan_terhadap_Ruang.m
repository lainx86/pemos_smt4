...
folder_output = 'output_Diskontinu_Upstream_Polutan_Terhadap_Ruang';
...
for s = 1:numel(scenario)
    ...
    title(sprintf('%s - Konsentrasi polutan terhadap ruang (Upstream)', scenario(s).nama), ...
    ...
    nama_file = sprintf('upstream_diskontinu_ruang_skenario_%d.png', s);
