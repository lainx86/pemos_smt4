...
folder_output = 'output_Diskontinu_FTCS_Adveksi_Difusi_Terhadap_Ruang';
...
for s = 1:numel(scenario)
    ...
    fprintf('dx = %.3f m, dt = %.3f s, u = %.3f m/s, D = %.3f m^2/s\n', ...
        dx, dt, u, D);
    fprintf('Grid sumber = %s\n', mat2str(m_source));
    ...
    nama_file = sprintf('ftcs_adveksi_difusi_ruang_diskontinu_skenario_%d.png', s);
