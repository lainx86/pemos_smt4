...
folder_output = 'output_Diskontinu_FTCS_Adveksi_Difusi_Terhadap_Waktu';
...
for s = 1:numel(scenario)
    ...
    fprintf('dx = %.3f m, dt = %.3f s, u = %.3f m/s, D = %.3f m^2/s, grid sumber = %s\n', ...
    ...
    nama_file = sprintf('ftcs_adveksi_difusi_waktu_diskontinu_skenario_%d.png', s);
