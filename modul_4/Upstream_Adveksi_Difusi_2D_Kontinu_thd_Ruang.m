...
folder_output = 'output_Kontinu_Upstream_Adveksi_Difusi_2D_Terhadap_Ruang';
...
for s = 1:4
    ...
    sgtitle({
        sprintf('Persamaan Adveksi-Difusi 2D - Sumber Polutan Kontinu - Grafik terhadap Ruang - %s', scenario(s).nama), ...
        identitas
    })
    
    nama_file = sprintf('upstream_adveksi_difusi_2D_ruang_kontinu_skenario_%d.png', s);
