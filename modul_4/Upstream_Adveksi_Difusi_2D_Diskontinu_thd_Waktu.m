...
folder_output = 'output_Diskontinu_Upstream_Adveksi_Difusi_2D_Terhadap_Waktu';
...
for s = 1:4
    ...
    nama_file = sprintf('upstream_adveksi_difusi_2D_waktu_diskontinu_skenario_%d.png', s);
